        ...
        <div class="row cart">
            <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-cart">
                        ...
                        <tbody>
                           ...
                           for($i=0;$i<count($arr_cart_room_id);$i++)
                           {
                            ...
                            <tr>
                                        <td>
                                            <a href="{{ route('cart_delete',$arr_cart_room_id) }}" class="cart-delete-link" onclick="return confirm('Are you sure?');"><i class="fa fa-times"></i></a>
                                        </td>
                                        <td>{{ $i+1 }}</td>                           
                                        <td><img src="{{ asset('uploads/'.$room_data->featured_photo) }}"></td>
                                        <td>
                                            <a href="room-detail.html" class="room-name">{{ $room_data->name }}</a>
                                        </td>
                ...
                <div class= "text-danger">
                    <h4 class= "2">Sepetiniz Boş!!</h4>
                    <h3><a href="{{ route('home') }}">Ana Sayfaya gitmek için tıklayın</a></h3>
                </div>
                @endif
            </div>
        </div>
