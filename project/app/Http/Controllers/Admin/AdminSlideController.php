...
class AdminSlideController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success','Slide is added succesfully.');
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect()->back()->with('success','Slide is updated succesfully.');
    }
    public function delete($id){
        ...
        return redirect()->back()->with('success','Slide is deleted succesfully.');
